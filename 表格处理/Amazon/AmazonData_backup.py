...
path_xls_win = 'D:/data/HD/采购物资情况台账(4).xlsx'#★★★★★★这里是你要读取的总表表格，路径及文件名可根据自己的需要自定义★★★★★★
...
create_xls_home.to_excel('D:/data/HD/总表.xlsx')#★★★★★★这里是创建的表格路径及名称，可自己修改单引号中的内容★★★★★★
...
create_xls_xn.to_excel('D:/data/HD/咸宁.xlsx')#★★★★★★这里是创建的表格路径及名称，可自己修改单引号中的内容★★★★★★
...
create_xls_other.to_excel('D:/data/HD/其他.xlsx')#★★★★★★这里是创建的表格路径及名称，可自己修改单引号中的内容★★★★★★
